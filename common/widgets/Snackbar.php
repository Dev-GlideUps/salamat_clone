...
class Snackbar extends \yii\base\Widget
{
     ...
     */
    public $actionButton = ['class' => 'salamat-color'];
    ...
    public function run()
    {
        ...
        foreach ($session->allFlashes as $type => $flash) {
            ...
            foreach ((array) $flash as $i => $message) {
                echo Html::beginTag('div', ['class' => "mdc-snackbar $messageType"]);
                    ...
                    if ($this->actionButton !== null && is_array($this->actionButton)) {
