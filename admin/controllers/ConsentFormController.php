...
use admin\models\ConsentFormSearch;
...
class ConsentFormController extends Controller
{
    ...
    public function actionCreate()
    {
        ...
        if ($model->load(Yii::$app->request->post()) && $model->save()) {
            Yii::$app->session->setFlash('success', Yii::t('clinic', "Saved successfully"));
    ...
    public function actionDelete($id)
    {
        ...
        Yii::$app->session->setFlash('error', Yii::t('clinic', "Removed successfully"));
