                            ...
                            [
                                ...
                                'buttons' => [
                                    'pdf' => function ($url, $model, $key) {
                                        $options = [
                                            'title' => Yii::t('general', 'Delete Consent'),
                                            'aria-label' => Yii::t('general', 'Delete Consent'),
                                            'target' => '_blank',
                                        ...
                                        $htmlData = Html::a("delete", ['consent-form/delete', 'id' => $model->id], $options) . Html::a("edit_document", ['/consent-form/update', 'id' => $model->id], $options2);
                                        return $htmlData;
                                    },
                                ],
                            ],
