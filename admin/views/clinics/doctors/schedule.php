...
$this->params['breadcrumbs'][] = Yii::t('general', 'Schedule');
...
<div class="container-custom">
    <div class="row">
        <div class="col">
            <div class="mdc-list-item mt-5 mb-3">
            ...
            <div class="card raised-card doctor-schedule">
                ...
                <div class="mdc-button-group direction-reverse p-3">
                    ...
                    <?= Html::a(Yii::t('general', 'Cancel'), ['view', 'id' => $doctor->id], ['class' => 'mdc-button btn-outlined salamat-color']) ?>
                </div>
                <?php ActiveForm::end(); ?>
            </div>
        </div>
