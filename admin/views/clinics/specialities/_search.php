...
/* @var $model clinic\models\SpecialitySearch */
/* @var $form yii\widgets\ActiveForm */
?>

<div class="speciality-search py-2 px-3">
    ...
    <div class="row align-items-center mx-n2">
        ...
        <div class="col-md-3 col-sm-4 px-2">
            <?= $form->field($model, 'title_ar')->label(false)->textInput([
                'placeholder' => $model->getAttributeLabel('title_ar'),
                'autocomplete' => 'off',
            ]) ?>
        </div>
