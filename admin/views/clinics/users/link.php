...
$this->title = Yii::t('user', 'Link Clinic to User');
$this->params['breadcrumbs'][] = Yii::t('clinic', 'Clinics Data');
$this->params['breadcrumbs'][] = ['label' => Yii::t('user', 'Users'), 'url' => ['index']];
$this->params['breadcrumbs'][] = Yii::t('general', 'Link');
?>

<div class="container-custom user-clinic-link">
    <div class="row">
        <div class="col">
            ...
            <div class="card raised-card">
                ...
                <?php $form = ActiveForm::begin(); ?>
                    ...
                    <div class="mdc-button-group direction-reverse p-0">
                        <?= Html::submitButton(Yii::t('user', 'Link'), ['class' => 'mdc-button btn-contained bg-salamat-color']) ?>
