...
abstract class BaseManager extends Component implements ManagerInterface
{
     ...
     * @param string|int $clinic the clinic ID. This should be either an integer or a string representing
     ...
     */
    protected function executeRule($user, $clinic, $item, $params)
    {
        ...
        if ($rule instanceof Rule) {
            return $rule->execute($user, $clinic, $item, $params);
        }
