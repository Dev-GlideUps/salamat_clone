...
$this->title = Yii::t('insurance', 'Insurance claims');
        ...
        <div class="col">
            ...
            <?= GridView::widget([
                ...
                'columns' => [
                    ...
                    [
                        'attribute' => 'insurance_seller',
                        'value' => function ($model) {
                            return $model->insuranceSeller->name;
                        },
                    ],
                    // [
                    //     'attribute' => 'total',
                    ...
                    [
                        'label' => '',
                        'value' => function ($model) {
                            if (!$model->insurance_claimed) {
                                return Html::tag('div', 'check', ['class' => 'material-icon md-18 rounded-circle bg-salamat-color p-1']);
                            }

                            return Html::tag('div', 'close', ['class' => 'material-icon md-18 rounded-circle bg-salamat-secondary p-1']);
                        },
                        'format' => 'html',
                    ],
