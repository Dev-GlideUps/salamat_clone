            ...
            <div class="card raised-card">
                ...
                <div class="card-body">
                    <div class="py-5 text-center">
                        <div class="empty-state-graphic" style="max-width: 15rem; margin: 0 auto;">
                            ...
                            <h5 class="text-hint my-3"><?= Yii::t('finance', 'Total amount: {total}', ['total' => $formatter->asDecimal($data['total'], 3)]) ?></h5>
                        </div>
                    </div>
                </div>
                <?php } else { ?>
                <div class="row justify-content-center">
                    <div class="col-xl-9 col-lg-8 col-md-7">
                        ...
                        <div class="row mx-1">
                            <div class="col-4"><div class="mdt-body-2"><?= $doctor['name'] ?></div></div>
                            <div class="col p-0">
                                <div class="row mx-0">
                                    <div class="col-4 pr-0"><div class="mdt-body text-secondary"><?= Yii::t('finance', 'Payed amount') ?></div></div>
                                    <div class="col">
                                ...
                                <div class="row mx-0">
                                    <div class="col-4 pr-0"><div class="mdt-body text-secondary"><?= Yii::t('finance', 'Balance due') ?></div></div>
                                    <div class="col"><div class="mdt-body"><?= $formatter->asDecimal($doctor['balance'], 3) ?></div></div>
                                </div>
                                <div class="mdc-divider my-2"></div>
                                <div class="row mx-0">
                                    <div class="col-4 pr-0"><div class="mdt-body text-secondary"><?= Yii::t('finance', 'VAT') ?></div></div>
                                    <div class="col"><div class="mdt-body"><?= $formatter->asDecimal($doctor['vat'], 3) ?></div></div>
                                </div>
                                <div class="mdc-divider my-2"></div>
                                <div class="row mx-0">
                                    <div class="col-4 pr-0"><div class="mdt-body text-secondary"><?= Yii::t('finance', 'Total amount') ?></div></div>
                                    <div class="col"><div class="mdt-body salamat-color"><?= $formatter->asDecimal($doctor['total'], 3) ?></div></div>
                                </div>
                            </div>
                        </div>
                        <div class="mdc-divider my-2"></div>
                        ...
                        <div class="row mx-1">
                            <div class="col-4 pr-0"><div class="mdt-body text-secondary"><?= Yii::t('finance', 'Balance due') ?></div></div>
                            <div class="col"><div class="mdt-body"><?= $formatter->asDecimal($data['balance'], 3) ?></div></div>
                        </div>
                        <div class="mdc-divider my-2"></div>
                        <div class="row mx-1">
                            <div class="col-4 pr-0"><div class="mdt-body text-secondary"><?= Yii::t('finance', 'VAT') ?></div></div>
                            <div class="col"><div class="mdt-body"><?= $formatter->asDecimal($data['vat'], 3) ?></div></div>
                        </div>
                        <div class="mdc-divider my-2"></div>
